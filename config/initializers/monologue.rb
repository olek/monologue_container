Monologue.sidebar              = ["latest_posts", "latest_tweets", "categories", "tag_cloud"]   # this will add the latests posts and latests tweets in the right sidebar.
...
Monologue.linkedin_url         = "http://www.linkedin.com/in/woodenbits" # if set, will enable Linked In icon and link to this URL.
Monologue.github_username      = "http://github.com/olek"  # if set, will enable Github icon and link to this URL.
